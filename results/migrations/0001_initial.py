# Generated by Django 4.0.3 on 2022-03-19 23:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sprint_p1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='sprint_p1', to='results.driver')),
                ('sprint_p2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='sprint_p2', to='results.driver')),
                ('sprint_p3', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='sprint_p3', to='results.driver')),
            ],
            options={
